...
@Service
public class GetItemCatalogService implements GetItemCatalogUseCase {

    private final DraftRepository draftRepository;
    private final PosConfigReader reader;

    public GetItemCatalogService(DraftRepository draftRepository, PosConfigReader reader) {
    ...
    public ItemCatalog getItemCatalog(String draftId) {
        ...
        return DraftServiceSupport.loadItemCatalog(draft, reader, draftRepository);
    }
}
